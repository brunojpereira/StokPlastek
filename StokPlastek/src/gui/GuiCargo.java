 ...
 * @author 12121001933
 */
public class GuiCargo extends javax.swing.JFrame {
    String modo="pesquisa";
    ResultSet rsPesquisa=null;
    private List<CargoBean> listaCargos =  new LinkedList<>();
    ...
    public GuiCargo(){
        ...
        defineModeloTabela();
        preencherTabelaCargo(txtPesquisa.getText());
        pangCargo.setEnabledAt(1,false);
    }
    ...
    private void initComponents() {
        ...
        txtDescCargo = new javax.swing.JTextArea();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        pangCargo.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        tblCargo.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        tblCargo.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        lblDescCargo.setText("Descrição:");
        ...
        txtDescCargo.setColumns(20);
        txtDescCargo.setRows(5);
        jScrollPane1.setViewportView(txtDescCargo);
            ...
            .addGroup(panCadastroLayout.createSequentialGroup()
                ...
                .addGroup(panCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panCadastroLayout.createSequentialGroup()
                        ...
                        .addGroup(panCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panCadastroLayout.createSequentialGroup()
                                .addComponent(txtidcargo, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(pangCargo, javax.swing.GroupLayout.PREFERRED_SIZE, 473, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(pangCargo, javax.swing.GroupLayout.PREFERRED_SIZE, 310, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void botCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botCancelarActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(pangCargo,
            msg,"Confirmação",
            JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
                txtidcargo.setText("");
                txtNomeCargo.setText("");
                txtDescCargo.setText("");
                pangCargo.setSelectedIndex(0);
                pangCargo.setEnabledAt(1, false);
                modo="pesquisa";
                botNovo.setEnabled(true);
                GuiPrincipal.frmCargo.setClosable(true);
                GuiPrincipal.frmCargo.setIconifiable(true);
                botNovo.setEnabled(true);
    ...
    private void botSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botSalvarActionPerformed
        try {
            ...
            if(JOptionPane.showConfirmDialog(pangCargo,
                    "Deseja realmente salvar este cargo?","Confirmação",
                    JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
                if(modo.equals("novo"))
                    cargoController.inserir(txtNomeCargo.getText(), txtDescCargo.getText());
                else
                    cargoController.alterar(Integer.parseInt(txtidcargo.getText()),txtNomeCargo.getText(), txtDescCargo.getText());
                limparCampos();
                limparTabela();
                preencherTabelaCargo("");
    ...
    private void botNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botNovoActionPerformed
        GuiPrincipal.frmCargo.setClosable(false);
        GuiPrincipal.frmCargo.setIconifiable(false);
        txtidcargo.setText("");
        txtNomeCargo.setText("");
        txtDescCargo.setText("");
        pangCargo.setSelectedIndex(0);
        pangCargo.setEnabledAt(1, true);
        pangCargo.setSelectedIndex(1);
    ...
    private void botEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botEditarActionPerformed
        ...
        if(tblCargo.getSelectedRow()>=0){
            modo="editar";
            CargoBean cargo = listaCargos.get(tblCargo.getSelectedRow());
            txtidcargo.setText(String.valueOf(cargo.getIdCargo()));
            txtNomeCargo.setText(cargo.getNomeCargo());
            txtDescCargo.setText(cargo.getDescCargo());
            GuiPrincipal.frmCargo.setClosable(false);
            GuiPrincipal.frmCargo.setIconifiable(false);
            botNovo.setEnabled(false);
            botEditar.setEnabled(false);
    ...
    private void botExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botExcluirActionPerformed
        if(tblCargo.getSelectedRow()>=0){
            if(JOptionPane.showConfirmDialog(pangCargo,
                "Deseja realmente excluir este cargo?","Confirmação",
                JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION){
                CargoBean cargo = listaCargos.get(tblCargo.getSelectedRow());
                try {
                    cargoController.excluir(cargo.getIdCargo(),cargo.getNomeCargo(),cargo.getDescCargo());
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(GuiCargo.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void preencherTabelaCargo(String pesquisa){
        listaCargos.removeAll(listaCargos);
        
        try {
            listaCargos = cargoController.consultar(pesquisa);
            for(CargoBean cargo : listaCargos){
                String[] linha = new String[3];
                linha[0]=(String.valueOf(cargo.getIdCargo()));
                linha[1]=(cargo.getNomeCargo());
                linha[2]=(cargo.getDescCargo());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiCargo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextArea txtDescCargo;
